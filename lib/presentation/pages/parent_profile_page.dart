...
// import '../../data/models/parent_request.dart';
...
//     final resp = await _service.getParentById(widget.parentId);
//     if (resp['success'] == true && resp['data'] != null) {
//       final data = resp['data'];

//       setState(() {
//         _nameCtl.text = data['studentName'] ?? "";
//         _emailCtl.text = data['email'] ?? "";
//         _contactCtl.text = data['contactNumber'] ?? "";
//         _relationCtl.text = data['relation'] ?? "";
//       });
//     } else {
//       if (mounted) {
...
//     final resp = await _service.updateParent(widget.parentId, req);
